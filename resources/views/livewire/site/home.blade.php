<div>
    <section class="relative bg-cover bg-gradient-to-b from-primary-200 to-primary-300 h-[80vh]">
        <div class="h-full" style="background-image: url({{ vite_asset('images/home-details.png') }})">
            <div class="container flex flex-col lg:flex-row items-center justify-around h-full pb-20">
                <img class="mb-4 lg:mb-0 w-10/12 lg:w-1/2 rounded-xl -rotate-6 drop-shadow-xl" src="{{ vite_asset('images/home-jackson-rafaela.png') }}" alt="Jackson e Rafaela andando de mãos dadas">

                <header class="text-center lg:text-right lg:w-1/2 text-primary-900">
                    <h1 class="font-cinzel text-4xl lg:text-6xl font-medium">Jackson & <br> Rafaela</h1>
                    <p class="font-montserrat font-light text-3xl mt-4 lg:mt-8">
